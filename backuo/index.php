...
<body>
	...
	<div class="slider">
		...
		<div class="slider__item"><img src="img/slider/doster.jpg" alt=""></div>
				...
				<?php
					for ($category = 1; $category<$GLOBALS['category_amount']; $category++){
				?>
					<div class="menu">
						<div class="container">
							<div class="menu__row">
										...
										?>
											<div class="menu__col">
												<div class="menu__item item-menu new">
													<img src="img/content_menu/pasta.png" alt="pasta" class="item-menu__dish">
													<div class="item-menu__description">
														...
														<div class="item-menu__pricerow">
															...
															<a href="#selection-popup" class="item-menu__btn popup-link btn1">ВЫБРАТЬ</a>
														</div>
													</div>
												</div>
												<?php
	...
	<div class="container">
		<div class="menu__row">
			<div class="menu__title">Блины</div>
			<div class="menu__items">
				<div class="menu__col">
					<div class="menu__item item-menu">
						<img src="img/content_menu/bliny.png" alt="bliny" class="item-menu__dish">
						<div class="item-menu__description">
							<div class="item-menu__title">С ветчиной и сыром</div>
							<div class="item-menu__recipe">Воздушные блинчики с сыром и ветчиной из свинины</div>
							<div class="item-menu__pricerow">
								<a href="#constructor-popup" class="item-menu__constructbtn popup-link btn3">СОБРАТЬ</a>
							</div>
						</div>
					</div>
				</div>
				<div class="menu__col">
					<div class="menu__item item-menu">
						...
						<div class="item-menu__description">
							...
							<div class="item-menu__recipe">Воздушные блинчики с сыром и ветчиной из свинины</div>
							<div class="item-menu__pricerow">
								<div class="item-menu__price">120 грн</div>
								<a href="#selection-popup" class="item-menu__btn popup-link btn1">ВЫБРАТЬ</a>
							</div>
						</div>
					</div>
					<div class="item-menu__flags">
						<div class="item-menu__flags-wrapper">
							<div class="item-menu__flag item-menu__flag-discount"><span>-10</span>%</div>
							<div class="item-menu__flag item-menu__flag-new">NEW</div>
						</div>
					</div>
					<div class="item-menu__bestprice-box">
					...
					<div class="selection-popup__row">
						...
						<div class="selection-popup__column">
							<div class="selection-popup__info">
								<div class="selection-popup__title" id="selection_popup_parameter_name">Паста Болоньезе</div>
								<div class="selection-popup__count" id="selection_popup_parameter_amount">1 шт.</div>
								<div class="selection-popup__description"id="selection_popup_parameter_description">Паста, мясной соус болоньезе, моцарелла, итальянские
									травы</div>
								<div class="selection-popup__price" id="selection_popup_parameter_price">120 грн</div>
