		...
		<div class="cart content">
			...
			<div class="cart__container">
				<div class="cart__content">
					...
					<a href="done.php" class="tabs-cart__confirm-btn btn1">Подтвердить</a>
				</div>
			</div>
		</div>
		<footer class="footer">
