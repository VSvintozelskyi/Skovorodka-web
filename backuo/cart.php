					...
					<div class="cart__profile">
						<div id="cart__user" class="cart__user">
							...
							<ul class="top-header__profile-dropdown cart__profile-dropdown">
								...
								<li><a href="logout.php" class="top-header__logout-icon">Выйти</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="cart__container">
				<div class="cart__content">
						...
						<div class="dishes-cart__item">
							<div class="dishes-cart__row">
								<div class="dishes-cart__img">
									<img src="img/cart/pasta.png" alt="pasta">
								</div>
								<div class="dishes-cart__dish dish-cart">
									<div class="dish-cart__title">Паста Болоньезе</div>
									<div class="dish-cart__description">Паста, мясной соус болоньезе, моцарелла, итальянские
										травы</div>
								</div>
								<div class="dishes-cart__change">
									<input class="dishes-cart__change-btn btn2" type="button" value="Изменить">
								</div>
								<div class="dishes-cart__price1">120 грн</div>
								<div class="dishes-cart__count"><span>2 шт</span></div>
								<div class="dishes-cart__price-n">240 грн</div>
								<div class="dishes-cart__delete-btn">
								</div>
							</div>
						</div>
						<div class="dishes-cart__item">
							<div class="dishes-cart__row">
								...
								<div class="dishes-cart__count"><span>2 шт</span></div>
								<div class="dishes-cart__price-n">240 грн</div>
								<div class="dishes-cart__delete-btn"></div>
							</div>
						</div>
						<div class="dishes-cart__item">
							<div class="dishes-cart__row">
						...
						<div class="cutlery-cart__items">
							<div class="cutlery-cart__item">
								<div class="cutlery-cart__row">
									...
									<div class="cutlery-cart__subtitle">Стандартный набор</div>
									<div class="cutlery-cart__change"></div>
									<div class="cutlery-cart__price1">20 грн</div>
									...
									<div class="cutlery-cart__price-n">40 грн</div>
									<div class="cutlery-cart__delete-btn"></div>
								</div>
							</div>
						</div>
					</div>
					<div class="cart__recommendation recommendation-cart">
						...
						<div class="recommendation-cart__slider slider-cart">
							<div class="slider-cart__item">
								<img class="slider-cart__foto" src="img/cart/cola.png" alt="Cola">
								<div class="slider-cart__info">
									<div class="slider-cart__title">Coca-Cola</div>
									<input class="slider-cart__price-btn btn3" type="button" value="20 грн">
								</div>
							</div>
							<div class="slider-cart__item">
								<img class="slider-cart__foto" src="img/cart/chiken.png" alt="Chicken">
								<div class="slider-cart__info">
									<div class="slider-cart__title">Куриные крылья в маринаде</div>
									<input class="slider-cart__price-btn btn3" type="button" value="20 грн">
								</div>
							</div>
							<div class="slider-cart__item">
								<img class="slider-cart__foto" src="img/cart/pizza.png" alt="Pizza">
								<div class="slider-cart__info">
									<div class="slider-cart__title">Куриные крылья в маринаде</div>
									<input class="slider-cart__price-btn btn3" type="button" value="20 грн">
								</div>
					...
					<div class="cart__btns">
						<a href="delivery.php" class="cart__checkout-btn btn1">Оформить заказ</a>
